---
title: Ep 21 - Taking a closer look at the dice roller
date: '2023-01-07'
updated: '2023-01-07'
excerpt: In this session we'll try to add some functionality to the dice roller so we can activate additional Power Cards.
categories: 
- live-stream
---
{excerpt}
